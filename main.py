...
KNOWLEDGE_BASE = {
    ...
    'what_is_this': {
        ...
        'answer': "Это бот VK Education Projects — витрины прикладных бизнес-кейсов от VK для школьников и студентов России. Здесь ты можешь решать реальные задачи по анализу данных, разработке, безопасности и креативу, использовать их для курсовых, дипломов или портфолио. Получи сертификат, рецензии и призы! \n\nЧтобы начать: выбери задачу на https://education.vk.company/education_projects. \n\nСкачай материалы:\n" + USEFUL_LINKS + "\n\nЧто именно интересует? 😊"
    }
}
